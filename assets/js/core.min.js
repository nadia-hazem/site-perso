...
Author:         Suelo (modified by @nadiaHazem)
-------------------------------------------------------------------------------- */
"use strict";
var Mi = {
    init: function () {
    ...
    Basic: {
        ...
        backgrounds: function () {
            $(".bg-image").each(function () {
                ...
                $(".bg-slideshow").owlCarousel({ singleItem: !0, autoPlay: 4e3, pagination: !1, navigation: !1, navigationText: !1, slideSpeed: 1500, transitionStyle: "fade", mouseDrag: !1, touchDrag: !1 });
        },
        animations: function () {
            $(".animated-hover")
                .on("mouseenter", function () {
                    ...
                    $(this)
                        .stop()
                        .css({ "-webkit-animation-duration": t + "ms", "animation-duration": t + "ms" })
                        .addClass(e);
                })
        ...
        scroller: function () {
            ...
            i.find("a").on("click", function () {
                ...
                i.localScroll({ offset: o, duration: 800, easing: $("#content").data("scroll-easing") });
        ...
        masonry: function () {
            var e = $(".masonry");
            e.masonry({ columnWidth: ".masonry-sizer", itemSelector: ".masonry-item", percentPosition: !0 }),
        ...
        /* forms: function () {
            var e,
                t,
                a = $(".basic-form");
            a.validate({ errorPlacement: function (e, t) {} }),
                a.submit(function () {
            ...
            o.validate({
                ...
                wrapper: "li",
                rules: { name: { required: !0, minlength: 2 }, email: { required: !0, email: !0 }, message: { required: !0, minlength: 10 } },
                messages: {
                    name: { required: "Entrez votre nom.", minlength: "Votre nom doit avoir au moins 2 caractères." },
                    email: { required: "Entrez votre adresse e-mail.", minlength: "Vous avez entré une adresse e-mail invalide." },
                    message: { required: "Entrez un message.", minlength: "Votre message doit être d'au moins 10 caractères." },
                },
            }),
                o.submit(function () {
                        ...
                        o.valid()
                            ? ($.ajax({
                                ...
                                success: function (t) {
                                    (a =
                                        "SEND" === t
                                            ? '<div class="alert alert-success">Merci pour votre message - Vous obtiendrez une réponse aussi vite que possible!'
                                            : '<div class="alert alert-danger">Oups... Il semble qu\'il y ai eu un problème.'),
                                        e.html(a),
                                        e.show();
                                },
                            }),
    ...
    Components: {
        ...
        /* navFilter: function () {
            ...
            e.on("click", "a", function () {
                ...
                return e.isotope({ filter: t }), $(this).parents(".nav").find(".active").removeClass("active"), $(this).parent("li").addClass("active"), !1;
            });
        }, */
    },
};
